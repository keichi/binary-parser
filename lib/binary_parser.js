...
BIT_RANGE.forEach(function(i) {
    NAME_MAP['bit' + i.toString()] = 'Bit' + i.toString();
});
...
BIT_RANGE.forEach(function(i) {
    var type = 'bit' + i.toString();
    Parser.prototype[type] = function(varName, options) {
...
BIT_RANGE.forEach(function(i) {
    Parser.prototype['generateBit' + i.toString()] = function(ctx) {
        Parser.prototype.generateBits.call(this, ctx, i);
    };
});

Parser.prototype.generateBits = function(ctx, i) {
    ctx.pushCode('// bits{0}', i);
};
...
Parser.prototype.generateString = function(ctx) {
    if (this.options.zeroTerminated) {
        ...
        ctx.pushCode('return buffer.toString(\'{0}\', start, offset - 1);', this.options.encoding);
        ctx.pushCode('})();');
    }
     else {
